...
CREATE TABLE "idempotency_records" (
    ...
    "expiresAt" DATETIME NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "idempotency_records_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "orders" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "wishlist_items_userId_productId_idx" ON "wishlist_items"("userId", "productId");
