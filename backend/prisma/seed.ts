...
const PRODUCT_NAMES: Record<string, string[]> = {
  ...
  'Routers': ['TP-Link Deco BE95 WiFi 7 Mesh', 'Netgear Orbi 970 Quad-Band', 'ASUS ROG Rapture GT-BE98', 'Eero Pro 7 Tri-Band Mesh', 'Linksys Velop MX4300 WiFi 6', 'Ubiquiti Dream Machine Pro Max', 'Google Nest WiFi Pro 6E', 'AmpliFi Alien WiFi 6 Mesh', 'TP-Link Archer BE800 WiFi 7', 'Synology RT6600ax Router'],
};
