...
-- CreateIndex
CREATE INDEX "products_originalPrice_idx" ON "products"("originalPrice");
...
-- CreateIndex
CREATE INDEX "products_isTopRated_idx" ON "products"("isTopRated");

-- CreateIndex
CREATE INDEX "products_soldCount_idx" ON "products"("soldCount");

-- CreateIndex
CREATE INDEX "products_trendingScore_idx" ON "products"("trendingScore");

-- CreateIndex
CREATE INDEX "products_name_categoryId_idx" ON "products"("name", "categoryId");

-- CreateIndex
CREATE INDEX "products_categoryId_basePrice_idx" ON "products"("categoryId", "basePrice");
...
-- CreateIndex
CREATE INDEX "job_records_name_idx" ON "job_records"("name");
...
-- AddForeignKey
ALTER TABLE "idempotency_records" ADD CONSTRAINT "idempotency_records_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE SET NULL ON UPDATE CASCADE;
