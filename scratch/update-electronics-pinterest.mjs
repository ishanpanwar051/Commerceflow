...
const categoriesData = {
  laptops: [
    "MacBook Pro 16-inch", "MacBook Air 15-inch", "Dell XPS 16", "Dell XPS 14",
    "Lenovo ThinkPad X1 Carbon", "Lenovo Legion Pro 7", "HP Spectre x360", "HP Omen 16",
    "ASUS ROG Strix G16", "ASUS Zenbook 14", "Acer Predator Helios Neo 16", "Microsoft Surface Laptop"
  ],
  tablets: [
    "iPad Pro 13-inch", "iPad Air", "iPad Mini", "Samsung Galaxy Tab S10 Ultra",
    "Samsung Galaxy Tab S10+", "Google Pixel Tablet", "OnePlus Pad 2", "Xiaomi Pad 7 Pro",
    "Lenovo Tab Extreme", "Microsoft Surface Pro", "Redmi Pad Pro", "OPPO Pad 3 Pro"
  ],
  monitors: [
    "Samsung Odyssey OLED G9", "LG UltraGear OLED Gaming Monitor", "Dell UltraSharp 4K Monitor", "ASUS ROG Swift Gaming Monitor",
    "Acer Predator Gaming Monitor", "BenQ 4K Monitor", "MSI MPG Gaming Monitor", "Gigabyte AORUS Gaming Monitor",
    "Apple Studio Display", "LG UltraWide Monitor", "Samsung Smart Monitor", "Dell Alienware Gaming Monitor"
  ],
  keyboards: [
    "Logitech MX Mechanical", "Keychron Q1 Pro", "Razer BlackWidow V4", "Corsair K100 RGB",
    "SteelSeries Apex Pro", "ASUS ROG Strix Scope", "Apple Magic Keyboard", "Logitech G915",
    "HyperX Alloy Origins", "Keychron K2", "Royal Kludge RK84", "NuPhy Air75"
  ],
  consoles: [
    "PlayStation 5", "PlayStation 5 Slim", "PlayStation 5 Pro", "Xbox Series X",
    "Xbox Series S", "Nintendo Switch OLED", "Nintendo Switch Lite", "Nintendo Switch 2",
    "Steam Deck OLED", "ASUS ROG Ally X", "Lenovo Legion Go", "MSI Claw"
  ],
  headphones: [
    "Sony WH-1000XM6", "Apple AirPods Max", "Bose QuietComfort Ultra", "Sennheiser Momentum 4",
    "JBL Tour One M3", "Beats Studio Pro", "Samsung Galaxy Buds3 Pro", "Apple AirPods Pro",
    "Sony WF-1000XM5", "Nothing Ear", "OnePlus Buds Pro", "Bose QuietComfort Earbuds"
  ],
  cameras: [
    "Sony Alpha A7 IV", "Sony Alpha A7R V", "Canon EOS R5", "Canon EOS R6 Mark II",
    "Nikon Z8", "Nikon Z6 III", "Fujifilm X-T5", "Fujifilm X100VI",
    "Panasonic Lumix S5 II", "GoPro HERO13 Black", "DJI Osmo Action 5 Pro", "Insta360 X5"
  ]
};
...
// Smartphones (12)
const phones = [
  { name: 'iPhone 17 Pro Max', image: 'https://i.pinimg.com/736x/90/95/2e/90952e9d35a04edbd67eb8eed0f72635.jpg' },
  { name: 'iPhone 17 Pro', image: 'https://i.pinimg.com/1200x/ba/d5/77/bad5770f437f1d95a70de20175464bda.jpg' },
  { name: 'Samsung Galaxy S26 Ultra', image: 'https://i.pinimg.com/736x/97/14/fb/9714fbfc0fe4761842a16bbf3622f88c.jpg' },
  { name: 'Samsung Galaxy S26+', image: 'https://i.pinimg.com/736x/d5/64/26/d56426cc8ad6a77dbb03e7e9ed5ffda3.jpg' },
  { name: 'Google Pixel 10 Pro XL', image: 'https://i.pinimg.com/736x/24/85/69/248569e562fc906baf54dbf9a9251112.jpg' },
  { name: 'Google Pixel 10 Pro', image: 'https://i.pinimg.com/1200x/f2/cf/35/f2cf35e863abad46bea5d3e1eb483404.jpg' },
  { name: 'OnePlus 13', image: 'https://i.pinimg.com/1200x/ab/03/1d/ab031db73e8ee1bf1c566f4b58fa0fcf.jpg' },
  { name: 'Xiaomi 16 Pro', image: 'https://i.pinimg.com/1200x/24/9c/14/249c14f8278394ba6b7070b66892fc51.jpg' },
  { name: 'Nothing Phone 3', image: 'https://i.pinimg.com/736x/01/8f/8a/018f8adb63275f1ed917e7082373978e.jpg' },
  { name: 'Realme GT 7 Pro', image: 'https://i.pinimg.com/736x/56/75/81/5675819358843349723552ca.jpg' },
  { name: 'Vivo X200 Pro', image: 'https://i.pinimg.com/736x/05/43/e0/0543e09d6fa1150b7b243004d28c989e.jpg' },
  { name: 'OPPO Find N5', image: 'https://i.pinimg.com/1200x/20/d3/ce/20d3cebe1bb19b1b94800fdf5d650a90.jpg' },
];

for (const p of phones) {
  allElectronicsProducts.push(p);
}

for (const [catName, items] of Object.entries(categoriesData)) {
  for (const name of items) {
    const img = realPins[pinIndex % realPins.length];
    allElectronicsProducts.push({ name, image: img });
    pinIndex++;
  }
}

console.log(`Generated ${allElectronicsProducts.length} Electronics products with verified Pinterest URLs.`);
...
const productsCode = allElectronicsProducts.map(p => `      { name: '${p.name.replace(/'/g, "\\'")}', image: '${p.image}' },`).join('\n');

const regex = /name: 'Electronics',\s+slug: 'electronics',\s+description: 'Electronic devices and accessories',\s+products: \[\s+[\s\S]*?\n    \],/;

const replacement = `name: 'Electronics',
    slug: 'electronics',
...
console.log('✓ Successfully updated user-catalog.ts!');
...
const overrides = {};
for (const p of allElectronicsProducts) {
...
// Find insertion point inside USER_CUSTOM_PRODUCT_IMAGES
...
console.log('✓ Successfully updated product-images.ts!');
